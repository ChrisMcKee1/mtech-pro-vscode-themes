...
Say hello to the official M Tech Pro Light theme. Ideal for coding in bright environments or for those who prefer a lighter look. With the additional "Sun" filter, you'll also get a warm coding experience.

Carefully calibrated for light environments
-------------------------------------------

M Tech Pro Light is thoughtfully designed to make your workspace feel comfortable in bright light. Whether you're working in natural daylight or just prefer a brighter interface, this theme ensures clarity and focus every step of the way.

One-time registration
---------------------

Upgrade your coding environment with a lifetime license to M Tech Pro and remove all pop-up messages. 
Register now and enjoy forever: https://tech.pro/vscode
...
- [new] M Tech Pro Light
- [new] M Tech Pro Light (filter Sun)
...
- [fix] when selecting a M Tech Pro theme, the icon theme will change along only if the current icon theme is already a M Tech Pro icon theme
